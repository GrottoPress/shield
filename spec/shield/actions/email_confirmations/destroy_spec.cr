...
describe Shield::EmailConfirmations::Destroy do
  it "ends email confirmation" do
    ...
    response = client.exec(EmailConfirmations::Destroy.with(
  ...
  it "requires logged in" do
    response = ApiClient.exec(EmailConfirmations::Destroy.with(
