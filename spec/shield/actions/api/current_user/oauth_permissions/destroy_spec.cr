...
describe Shield::Api::CurrentUser::OauthPermissions::Destroy do
  it "revokes OAuth permission" do
    ...
    response = client.exec(Api::CurrentUser::OauthPermissions::Destroy.with(
      oauth_client_id: oauth_client.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::CurrentUser::OauthPermissions::Destroy.with(
      oauth_client_id: 45
    ))
