...
describe Shield::Api::Users::EmailConfirmations::Delete do
  it "deletes email confirmations" do
    ...
    response = client.exec(Api::Users::EmailConfirmations::Delete.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::EmailConfirmations::Delete.with(
      user_id: 4
    ))
