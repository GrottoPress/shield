...
describe Shield::Api::Users::EmailConfirmations::Index do
  it "renders index page" do
    ...
    response = client.exec(
      Api::Users::EmailConfirmations::Index.with(user_id: user.id)
    )
  ...
  it "requires logged in" do
    response = ApiClient.exec(
      Api::Users::EmailConfirmations::Index.with(user_id: 4)
    )
