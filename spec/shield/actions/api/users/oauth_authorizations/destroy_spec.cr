...
describe Shield::Api::Users::OauthAuthorizations::Destroy do
  it "deactivates OAuth authorizations" do
    ...
    response = client.exec(Api::Users::OauthAuthorizations::Destroy.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::OauthAuthorizations::Destroy.with(
      user_id: 6
    ))
