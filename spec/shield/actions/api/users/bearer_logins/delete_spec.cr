...
describe Shield::Api::Users::BearerLogins::Delete do
  it "deletes bearer logins" do
    ...
    response = client.exec(
      Api::Users::BearerLogins::Delete.with(user_id: user.id)
    )
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::BearerLogins::Delete.with(user_id: 6))
