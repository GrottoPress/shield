...
describe Shield::Api::Users::OauthAccessTokens::Index do
  it "lists OAuth access tokens" do
    ...
    response = client.exec(Api::Users::OauthAccessTokens::Index.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::OauthAccessTokens::Index.with(
      user_id: 6
    ))
