...
describe Shield::Api::Users::OauthGrants::Index do
  it "lists OAuth grants" do
    ...
    response = client.exec(Api::Users::OauthGrants::Index.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::OauthGrants::Index.with(
      user_id: 6
    ))
