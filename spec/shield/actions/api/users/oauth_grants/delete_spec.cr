...
describe Shield::Api::Users::OauthGrants::Delete do
  it "deletes OAuth grants" do
    ...
    response = client.exec(Api::Users::OauthGrants::Delete.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::OauthGrants::Delete.with(
      user_id: 6
    ))
