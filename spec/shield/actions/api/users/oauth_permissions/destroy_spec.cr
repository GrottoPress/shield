...
describe Shield::Api::Users::OauthPermissions::Destroy do
  it "revokes OAuth permission" do
    ...
    response = client.exec(Api::Users::OauthPermissions::Destroy.with(
      oauth_client_id: oauth_client.id,
  ...
  it "requires logged in" do
    response = ApiClient.exec(Api::Users::OauthPermissions::Destroy.with(
      oauth_client_id: 45,
      user_id: 23
    ))
