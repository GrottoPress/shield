...
describe Shield::Users::OauthAccessTokens::Destroy do
  it "deactivates OAuth access tokens" do
    ...
    response = client.exec(Users::OauthAccessTokens::Destroy.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::OauthAccessTokens::Destroy.with(
      user_id: 6
    ))
