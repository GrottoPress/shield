...
describe Shield::Users::BearerLogins::Index do
  it "renders index page" do
    ...
    response = client.exec(Users::BearerLogins::Index.with(user_id: user.id))

    response.body.should eq("Users::BearerLogins::IndexPage")
  end

  it "requires logged in" do
    response = ApiClient.exec(Users::BearerLogins::Index.with(user_id: 6))
