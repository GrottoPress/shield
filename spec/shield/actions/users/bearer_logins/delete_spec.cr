...
describe Shield::Users::BearerLogins::Delete do
  it "deletes bearer logins" do
    ...
    response = client.exec(Users::BearerLogins::Delete.with(user_id: user.id))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::BearerLogins::Delete.with(user_id: 6))
