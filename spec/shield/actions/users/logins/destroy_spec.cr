...
describe Shield::Users::Logins::Destroy do
  it "logs user out everywhere" do
    ...
    response = client.exec(Users::Logins::Destroy.with(user_id: user.id))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::Logins::Destroy.with(user_id: 4))
