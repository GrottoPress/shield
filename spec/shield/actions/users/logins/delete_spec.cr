...
describe Shield::Users::Logins::Delete do
  it "logs user out everywhere" do
    ...
    response = client.exec(Users::Logins::Delete.with(user_id: user.id))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::Logins::Delete.with(user_id: 4))
