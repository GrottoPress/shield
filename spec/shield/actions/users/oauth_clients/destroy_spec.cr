...
describe Shield::Users::OauthClients::Destroy do
  it "deletes OAuth clients" do
    ...
    response = client.exec(Users::OauthClients::Destroy.with(user_id: user.id))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::OauthClients::Destroy.with(user_id: 6))
