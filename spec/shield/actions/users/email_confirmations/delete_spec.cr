...
describe Shield::Users::EmailConfirmations::Delete do
  it "deletes email confirmations" do
    ...
    response = client.exec(Users::EmailConfirmations::Delete.with(user_id: user.id))
  ...
  it "requires logged in" do
    response = ApiClient.exec(
      Users::EmailConfirmations::Delete.with(user_id: 4)
    )
