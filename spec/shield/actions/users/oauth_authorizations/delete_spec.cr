...
describe Shield::Users::OauthAuthorizations::Delete do
  it "deletes OAuth authorizations" do
    ...
    response = client.exec(Users::OauthAuthorizations::Delete.with(
      user_id: user.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(Users::OauthAuthorizations::Delete.with(
      user_id: 6
    ))
