...
describe Shield::OauthAuthorizations::Destroy do
  it "revokes OAuth authorization" do
    ...
    response = client.exec(OauthAuthorizations::Destroy.with(
  ...
  it "requires logged in" do
    response = ApiClient.exec(OauthAuthorizations::Destroy.with(
