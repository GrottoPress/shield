...
describe Shield::OauthClients::Destroy do
  it "deactivates OAuth client" do
    ...
    response = client.exec(OauthClients::Destroy.with(
  ...
  it "requires logged in" do
    response = ApiClient.exec(OauthClients::Destroy.with(oauth_client_id: 45))
