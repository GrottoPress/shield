...
describe Shield::CurrentUser::OauthPermissions::Delete do
  it "revokes OAuth permission" do
    ...
    response = client.exec(CurrentUser::OauthPermissions::Delete.with(
      oauth_client_id: oauth_client.id
    ))
  ...
  it "requires logged in" do
    response = ApiClient.exec(CurrentUser::OauthPermissions::Delete.with(
      oauth_client_id: 45
    ))
