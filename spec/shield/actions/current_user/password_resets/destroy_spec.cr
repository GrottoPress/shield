...
describe Shield::CurrentUser::PasswordResets::Destroy do
  it "ends password resets" do
    ...
    response = client.exec(CurrentUser::PasswordResets::Destroy)
  ...
  it "requires logged in" do
    response = ApiClient.exec(CurrentUser::PasswordResets::Destroy)
