...
describe Shield::CurrentUser::EmailConfirmations::Delete do
  it "deletes email confirmations" do
    ...
    response = client.exec(CurrentUser::EmailConfirmations::Delete)
  ...
  it "requires logged in" do
    response = ApiClient.exec(CurrentUser::EmailConfirmations::Delete)
