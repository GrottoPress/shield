...
en:
  action:
    ...
    bearer_login:
      ...
      update:
        failure: Could not update bearer login
        success: Bearer login updated successfully
    current_login:
      create:
    ...
    current_user:
      ...
      oauth_authorization:
        destroy:
          failure: Could not delete authorizations
    ...
    oauth_authorization:
      destroy:
        failure: Could not delete authorization
  ...
  operation:
    error:
      ...
      bearer_login_inactive: Bearer login is inactive
      ...
      pkce_required: Code challenge is required
