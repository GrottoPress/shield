module Shield::Api::Users::OauthPermissions::Destroy
  macro included
    ...
    def do_run_operation_succeeded(operation, oauth_client)
      json OauthClientSerializer.new(
        ...
        user: user,
        message: Rex.t(:"action.user.oauth_permission.destroy.success")
      )
    end
    ...
    def do_run_operation_failed(operation)
      json FailureSerializer.new(
        ...
        message: Rex.t(:"action.user.oauth_permission.destroy.failure")
      )
    end
